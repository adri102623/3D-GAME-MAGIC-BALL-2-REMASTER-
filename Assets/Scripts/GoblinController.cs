...
public class GoblinController : MonoBehaviour
{
    ...
    [Tooltip("Tiempo adicional único para este goblin (para mayor desincronización)")]
    [Range(0f, 5f)]
    ...
    {
        // Tiempo base aleatorio + tiempo único adicional configurado para este goblin específico
